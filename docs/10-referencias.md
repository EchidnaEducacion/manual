...
- [Empieza a trabajar con EchidnaML y EchidnaBlocks](https://echidna.es/a-programar/echidnaml/empezar-con-echidnaml-y-echidnablocks/): vídeos explicativos
...
- [Actividades para su uso en Primaria y Secundaria](https://echidna.es/didactica/actividades/)

**LearningML**: <https://web.learningml.org/>

- [Manual de learningML](https://web.learningml.org/manual-de-learningml/)
- [LearnigML online](https://basic.learningml.org/editor/)

**Scratch**: <https://scratch.mit.edu/>

- [Tutorial de introducción](https://scratch.mit.edu/projects/editor/?tutorial=getStarted)
- [Explorar proyectos de iniciación](https://scratch.mit.edu/starter-projects)

**Arduino:**

- [Descargar IDE Arduino](https://www.arduino.cc/en/software/)
- [Instalar IDE de Arduino:](https://docs.arduino.cc/software/ide-v2/tutorials/getting-started-ide-v2/)
