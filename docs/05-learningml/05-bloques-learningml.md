...
<td style="width: 24.4422%; height: 79px"><img src="../assets/images/clasificarTexto.png" title="Clasifica texto" alt="Clasifica texto"  width="300" /></td>
...
<td style="width: 24.4422%; height: 23px"><img src="../assets/images/confianzatexto.png" title="Confianza texto" alt="Confianza texto"  width="359" /></td>
...
<td style="width: 24.4422%; height: 23px"><img src="../assets/images/clasificarimagen.png" title="Clasificar imagen" alt="Clasificar imagen"  width="285" /></td>
...
<tr class="even" style="height: 23px;">
<td style="width: 24.4422%; height: 23px"><img src="../assets/images/confianzaimagen.png" title="Confianza imagen" alt="Confianza imagen"  width="432" /></td>
...
<tr class="odd" style="height: 23px;">
<td style="width: 24.4422%; height: 23px"><img src="../assets/images/imagenvideo.png" title="Imagen de vídeo" alt="Imagen de vídeo"  width="220" /></td>
<td style="width: 75.5578%; height: 23px"><strong>Imagen de vídeo:</strong> devuelve la imagen tomada por la webcam.</td>
</tr>
<tr class="even" style="height: 23px;">
<td style="width: 24.4422%; height: 23px"><img src="../assets/images/activarVideo.png" title="Activar video" alt="Activar video"  width="332" /></td>
...
<tr class="odd" style="height: 23px;">
<td style="width: 24.4422%; height: 23px"><img src="../assets/images/disfrazActual.png" title="disfraz actual" alt="disfraz actual"  width="231" /></td>
<td style="width: 75.5578%; height: 23px"><strong>Disfraz actual:</strong> devuelve el disfraz actual activo.</td>
</tr>
<tr class="even">
<td style="width: 24.4422%"><img src="../assets/images/clasificarNumeros.png" title="Clasificar números" alt="Clasificar números"  width="305" /></td>
...
<tr class="odd">
<td style="width: 24.4422%"><img src="../assets/images/confianza_numeros.png" title="confianza numeros" alt="confianza numeros"  width="398" /></td>
