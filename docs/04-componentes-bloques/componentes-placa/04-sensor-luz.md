...
![Sensor luz LDR](../../assets/images/SensorLuz-LDR.png "Sensor luz LDR"){ width="200" }
...
![bloque sensor luz](../../assets/images/bloque_sensor_luz.png "bloque sensor luz"){ width="224" }
...
![Ejemplo sensor luz](../../assets/images/Ejemplo_sensor_luz.png "Ejemplo sensor luz"){ width="556" }
